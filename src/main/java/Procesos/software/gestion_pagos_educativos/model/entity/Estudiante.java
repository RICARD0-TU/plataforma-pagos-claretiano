...
public class Estudiante {
    ...
    @JsonIgnoreProperties({"estudiantes", "notificaciones", "password", "hibernateLazyInitializer", "handler"})
    ...
    public List<Deuda> getDeudas() { return deudas; }
    public void setDeudas(List<Deuda> deudas) { this.deudas = deudas; }
}
